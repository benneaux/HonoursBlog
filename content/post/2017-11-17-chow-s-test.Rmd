...
Now I'll use the strucchange package to test for breaks. I'll fill out the detail of what is happening here later.
...
plot(iliwin, type = "l")
lines(ts(fitted(lvfit), start = 1, frequency = 1), col = 4)
...
legend("topright", 
       ...
       ncol = 1,
       title="Legend", 
       c("%ILI","Fit","Breaks","Conf.Int","Years"), 
       horiz=FALSE, 
       lty=c(1,1,2,1,2), 
       lwd=c(2,1.5,1,1,1), 
       col=c("black","blue","black","red","lightgrey"))
```
